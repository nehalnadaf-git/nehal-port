  ...
  itemListElement: [
    {
      ...
      item: {
        '@type': 'VideoObject',
        name: 'Brand Reel 01 — Cinematic Short Film',
        description: 'Cinematic brand reel — short-form video production and colour grading in DaVinci Resolve by Nehal Nadaf, Hubli Karnataka.',
        thumbnailUrl: cldPoster('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111535/1_10.mp4'),
        contentUrl: cldVideo('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111535/1_10.mp4'),
    ...
    },
    {
      ...
      item: {
        '@type': 'VideoObject',
        name: 'Brand Reel 02 — Social Media Video',
        description: 'Short-form social media brand reel — Instagram Reels video production by Nehal Nadaf.',
        thumbnailUrl: cldPoster('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111466/1_9.mp4'),
        contentUrl: cldVideo('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111466/1_9.mp4'),
        uploadDate: '2025-07-18',
        author: { '@id': `${SEO.baseUrl}/#person` },
      },
    },
    {
      ...
      item: {
        '@type': 'VideoObject',
        name: 'Brand Reel 03 — Cinematic Brand Film',
        description: 'Cinematic brand film with professional colour grading — DaVinci Resolve, produced by Nehal Nadaf, Hubli.',
        thumbnailUrl: cldPoster('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111448/1_8.mp4'),
        contentUrl: cldVideo('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111448/1_8.mp4'),
        uploadDate: '2025-07-18',
        author: { '@id': `${SEO.baseUrl}/#person` },
      },
    },
    {
      ...
      item: {
        '@type': 'VideoObject',
        name: 'Brand Reel 04 — Short Form Production',
        description: 'Short-form video content production for social media — Instagram and YouTube by Nehal Nadaf.',
        thumbnailUrl: cldPoster('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111401/1_7.mp4'),
        contentUrl: cldVideo('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111401/1_7.mp4'),
        uploadDate: '2025-07-18',
        author: { '@id': `${SEO.baseUrl}/#person` },
      },
    },
    {
      ...
      item: {
        '@type': 'VideoObject',
        name: 'Brand Reel 05 — Video Portfolio',
        description: 'Professional brand reel with advanced colour grading — DaVinci Resolve, produced by Nehal Nadaf, Hubli Karnataka.',
        thumbnailUrl: cldPoster('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111364/1_6.mp4'),
        contentUrl: cldVideo('https://res.cloudinary.com/ep3ji8zn/video/upload/v1787111364/1_6.mp4'),
        uploadDate: '2025-07-18',
        author: { '@id': `${SEO.baseUrl}/#person` },
      },
    },
