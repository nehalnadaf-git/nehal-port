...
export const SEO = {
  ...
  longDescription:
    'Nehal Nadaf is a multi-disciplinary creative professional based in Hubli, Karnataka, India — available for remote and on-site work across India and internationally. He specialises in premium web development (React.js, Next.js, Tailwind CSS, GSAP), UI/UX design (Figma), professional video production and colour grading (DaVinci Resolve), social media content creation, and influencer marketing. He has delivered 9+ live client websites across the automotive detailing, dental healthcare, restaurant, food service, and home-appliance repair industries. His creative agency manages influencer collaborations for brands across Karnataka, connecting them with content creators averaging 50K–100K+ views on Instagram. He works with clients locally in Hubli and Dharwad, remotely across India, and internationally worldwide.',
